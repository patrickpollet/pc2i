...
class familleRecord {
	...
	*/
	 public function familleRecord($alinea=0,$auteur='',$auteur_mail='',$commentaires='',$error='',$famille='',$idf=0,$mots_clesf='',$referentielc2i='',$tags='',$ts_datecreation=0,$ts_dateutilisation=0){
		 $this->alinea=$alinea   ;
		 $this->auteur=$auteur   ;
