...
if ($id == "-1") { // ajout de l'item
   ...
   //  $ligne->etablissement=$USER->id_etab_perso;  NON !!!
    ...
    //si le mot de passe a chang� (on a envoy� le md5 dans la fiche d'ajout)
    ...
    // d�saffecter les profils existants pour cet utilisateur
    delete_records("droits","login='".addslashes($id)."'");  // rev 984
}

// affecter les nouveaux profils � la personne
...
if ($env_mail) {
    ...
    $ligne->password=$mdp; // non encod� md5 !!!
