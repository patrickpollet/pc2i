...
function verif_form1(){
    ...
    // gestion de l'envoi des listes d�roulantes dans des champs r�cup�rables
...
$tpl->assignInclude("corps", $fiche,T_BYVAR); // le template g�rant le personnel
...
if ($id !=-1) { // modification de la personne
    ...
    $tpl->assign("readonly", " readonly=\"readonly\"");
        $tab = array (); // tableau contenant les profils � indiquer; permet de g�rer les doublons avec la liste restante
