 ...
 * les parametres envoyï¿½s a config_m doivent ï¿½tre exactement les noms des colonnes de la BD
 */
...
$tpl->assignInclude("corps", $page, T_BYVAR); // le template gï¿½rant la configuration
