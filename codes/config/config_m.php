...
v 1.41 les valeurs par d�faut sont TOUTES en base ...voir lib_ldap.php/maj_bd_ldap()
...
//validation
if (!empty($doit)) {
    //probl�me avec les valeurs vides ....gere par validation.js si n�cessaire
	...
	if ($elt == "param_nb_aleatoire") {
        ...
        $refs=get_referentiels(); //tri� par referentiel
...
// valeurs par d�faut et validation




//a on commenc� par $CFG au d�but (elt=CFG_xxxxx);
