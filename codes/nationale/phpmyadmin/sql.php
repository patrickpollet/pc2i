...
/**
 * code pratiquement inchangé de phpmyadmin/libraries/export/sql.php
 */
/**
...
function PMA_getTableDef($db, $table, $crlf, $error_url, $show_dates = false)
{
    ...
    $result = PMA_DBI_query('SHOW TABLE STATUS FROM ' . PMA_backquote($db) . ' LIKE \'' . PMA_sqlAddslashes($table) . '\'', null, null);
    if ($result != FALSE) {
...
function PMA_exportData($db, $table, $crlf, $error_url, $sql_query)
{
    ...
    **/
    ...
    $result      = PMA_DBI_query($sql_query, null, null);
    if ($result != FALSE) {
