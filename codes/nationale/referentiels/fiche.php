...
$tpl->assign("_ROOT.titre_popup",traduction("fiche_referentiel") . " " . $ligne->referentielc2i);

$ligne->domaine =affiche_texte($ligne->domaine);
...
if ($liste=get_questions_par_referentiel($id,true)) {  //seulement les valid�es)
