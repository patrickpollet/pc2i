...
Elles sont instanci�es et ajout�es selon les droits



//voir le script codes/notions/notions.php d�s la version 1.5
...
de nommage :
      ...
      ne pas oublier d'ajouter une entr�e pour les entetes des colonnes (voir
      le template entetes_icones_action.tpl)
l'ordre d'apparition des icones est fix� par l'ordre des blocs ici

les classes (icone_action) doivent �tre dans la feuille de style

version 1.5 sans les scripts MM_swapimage
on met syst�matiquement une image transparente de 20x20 et c'est via le CSS
