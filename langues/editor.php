<?php // $Id$ 
//fichier de traduction du widget HTMLArea
$string=array();
...
$string['configeditorplugins'] = 'Veuillez sélectionner les plugin d\'éditeurs de texte que vous désirez utiliser et les classer dans l\'ordre que vous recommandez.';
