 ...
 * @return bool
/// PP en Moodle TOUTE table a une clï¿½ id (autonum en 1er)
/// ce qui n'est pas TOUJOURS le cas de la PF
/// donc j'ai ajoutï¿½ ï¿½ update_record DEUX paramï¿½tres optionnels key1 et key2
/// pour gï¿½rer le where
...
function update_record($table, $dataobject, $key1 = 'id', $key2 = '', $die = 1, $errMsg1 = "", $errMsg2 = "") {
    ...
    // idem pour l'autre critï¿½re si prï¿½sent ...
    if (!empty ($key2)) {
