...
//
// --------------------------------------------------------------------------------
// $Id: pclzip-trace.lib.php,v 1.64 2009/03/24 17:13:52 vblavet Exp $
// --------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------
  ...
  function privOptionDefaultThreshold(&$p_options)
  {
    ...
    PclTraceFctMessage(__FILE__, __LINE__, 3,"Threshold value is : ".$p_options[PCLZIP_OPT_ADD_TEMP_FILE_THRESHOLD]." bytes");

    // ----- Sanity check : No threshold if value lower than 1M
    if ($p_options[PCLZIP_OPT_ADD_TEMP_FILE_THRESHOLD] < 1048576) {
      PclTraceFctMessage(__FILE__, __LINE__, 3,"Unset the threshold (value ".$p_options[PCLZIP_OPT_ADD_TEMP_FILE_THRESHOLD].") because under 1Mo sanity check)");
