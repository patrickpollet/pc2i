  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="55%" valign="top"><?php
          ...
          echo "<br />";
          echo "<iframe id=\"ibrowser\" name=\"ibrowser\" src=\"{$CFG->wwwroot}/commun/editeurs/htmlarea/coursefiles.php?usecheckboxes=0&ide=$ide&id=$id\" style=\"width: 100%; height: 200px;\"></iframe>";
      ?>
      </td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        if(0) {  // has_capability('moodle/course:managefiles', get_context_instance(CONTEXT_COURSE, $id))) {
            ?>
      ...
      <td height="22">
        <!--
         ...
         -->
          ...
          <input type="hidden" name="id" VALUE="<?php print($id);?>" />" .
          <input type="hidden" name="ide" VALUE="<?php print($ide);?>" />
          <input type="hidden" name="wdir" value="" />
