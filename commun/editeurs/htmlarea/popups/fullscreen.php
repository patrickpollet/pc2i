...
<script type="text/javascript" src="../htmlarea.php?id=<?php echo($id); ?>"></script>
...
function init() {
    ...
    config.btnList["popupeditor"] = [ "<?php print_string("minimize","editor");?>", "<?php echo $CFG->wwwroot ?>/commun/editeurs/htmlarea/images/fullscreen_minimize.gif", true,
